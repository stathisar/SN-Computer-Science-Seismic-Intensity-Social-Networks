...
text_pre_process <- function(corpus, count_threshold = 10, dic = NULL) {
  ...
  if (is.null(dic)) {
    ...
    stopwords <- c(letters, "και", "the", "br", "α","β","γ","δ","ε","ζ","η","θ","ι","κ","λ","μ","ν","ξ","ο","π","ρ","σ","τ","υ","φ","χ","ψ","ω")
...
make_bucket_data <- function(word_vec_list, labels, dic, seq_len = c(20), right_pad = T) {
